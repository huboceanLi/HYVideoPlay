//XHWGAZRUPETNKAIAMBXVQLRGIRWDSOHEMKYZZRDPEHRVIOZFTLOSVRJRAWIWCSCOVVSFCJXRGQNFUEBVJSWZVUOEKSTBEDZPACEP
//
//  YJHYLocalPathManager.h
//  HYReadBook
//
...
@interface YJHYLocalPathManager : NSObject
