//TVBAAUNZBADWLWBUKSNAYJEOLUQIVXMATJLMYSWNYKOSGGYXNIDPDTZYFCNKGCDUYMRVIBJVCQOOEUDLYPOOBQVPGYXEXPMYTYDA
//
//  YJHYUkVideoConfigManager.h
//  HYUKSDK
//
...
@interface YJHYUkVideoConfigManager : NSObject

+ (YJHYUkVideoConfigManager *)sharedInstance;
